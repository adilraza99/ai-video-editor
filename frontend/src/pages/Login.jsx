...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (result.success) {
      ...
      // Dynamic cinematic transition delay
      setTimeout(() => {
        navigate('/');
      }, 800);
    } else {
  ...
  return (
    <div className={`auth-page-wrapper ${isTransitioning ? 'transitioning' : ''}`}>
      ...
      <div className="auth-container">
        <div className={`auth-box glass-card ${isTransitioning ? 'exit-scale' : 'entry-anim'}`}>
          <div className="auth-header staggered-item">
            ...
            <h1 className="staggered-item">Welcome back to Clueso</h1>
            <p className="subtitle staggered-item">Create cinematic videos with AI</p>
          </div>
          ...
          <div className="auth-footer staggered-item" style={{ '--delay': '0.4s' }}>
            <p>
              New to Clueso?{' '}
      ...
      <style jsx>{`
                ...
                .exit-scale {
                    animation: cardExit 0.6s cubic-bezier(0.4, 0, 1, 1) forwards;
                }
